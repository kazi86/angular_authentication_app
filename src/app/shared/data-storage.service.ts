...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    this.http
      .put(
        'https://http-requests-backend-default-rtdb.firebaseio.com/recipes.json',
        recipes
      )
      .subscribe(response => {
  ...
  fetchRecipes() {
     ...
     return this.http
       .get<Recipe[]>('https://http-requests-backend-default-rtdb.firebaseio.com/recipes.json',).pipe(
         map(recipes => {
